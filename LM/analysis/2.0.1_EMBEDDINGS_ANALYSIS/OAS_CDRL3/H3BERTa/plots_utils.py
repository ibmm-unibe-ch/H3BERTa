...
"IGKV1": {'color': mcolors.to_rgba("#56B4E9", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV1D": {'color': mcolors.to_rgba("#E69F00", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV2D": {'color': mcolors.to_rgba("#D55E00", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV2": {'color': mcolors.to_rgba("#CC79A7", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV3": {'color': mcolors.to_rgba("#F0E442", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV3D": {'color': mcolors.to_rgba("#009E73", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV4": {'color': mcolors.to_rgba("#0072B2", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV5": {'color': mcolors.to_rgba("#56B4E9", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV6": {'color': mcolors.to_rgba("#E69F00", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGKV6D": {'color': mcolors.to_rgba("#D55E00", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV1": {'color': mcolors.to_rgba("#CC79A7", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV10": {'color': mcolors.to_rgba("#F0E442", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV2": {'color': mcolors.to_rgba("#009E73", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV4": {'color': mcolors.to_rgba("#56B4E9", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV5": {'color': mcolors.to_rgba("#E69F00", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV6": {'color': mcolors.to_rgba("#D55E00", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV7": {'color': mcolors.to_rgba("#CC79A7", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV8": {'color': mcolors.to_rgba("#F0E442", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGHD6": {'color': mcolors.to_rgba("#009E73", alpha=0.8), 'size': 3, 'marker': 'o'},
"IGLV9": {'color': mcolors.to_rgba("#0072B2", alpha=0.8), 'size': 3, 'marker': 'o'}, 
...
"K": {'color': mcolors.to_rgba("#56B4E9", alpha=0.9), 'size': 3, 'marker': 'o'},
"L": {'color': mcolors.to_rgba("#CC79A7", alpha=0.9), 'size': 3, 'marker': 'o'},
}
...
custom_colors = [
    ...
    "#393b79"  # colore extra nel caso serva
]

names = [
    "IGKV1","IGKV1D","IGKV2D","IGKV2","IGKV3","IGKV3D","IGKV4","IGKV5","IGKV6","IGKV6D",
    "IGLV1","IGLV10","IGLV2","IGLV4","IGLV5","IGLV6","IGLV7","IGLV8","IGHD6","IGLV9"
]

custom_palette = {
    name: {
        'color': mcolors.to_rgba(custom_colors[i % len(custom_colors)], alpha=0.8),
        'size': 3,
        'marker': 'o'
    }
...
def plot_umap_single_gene_numeric_INSCAPE_cmaporizzontale(
    ...
    cbar.ax.set_xlabel(title, fontsize=14, labelpad=10)
