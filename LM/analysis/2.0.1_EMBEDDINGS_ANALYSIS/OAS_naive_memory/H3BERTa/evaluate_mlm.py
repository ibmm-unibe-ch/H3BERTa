...
def main(model_name, model_path, csv_file, embedding_file, plot_title, hue_class, reduction_output_path, umap=False, pca=False):
    ...
    if umap == True:
        ...
        UMAP_reduce_and_visualize_embeddings(data, plot_title + ' UMAP', hue_class, img_output_file='img/UMAP_'+plot_title+'.png',reduction_output_path = reduction_output_path +'/UMAP_'+plot_title+'.csv')
    if pca == True:
        # Reduce and visualize embeddings
