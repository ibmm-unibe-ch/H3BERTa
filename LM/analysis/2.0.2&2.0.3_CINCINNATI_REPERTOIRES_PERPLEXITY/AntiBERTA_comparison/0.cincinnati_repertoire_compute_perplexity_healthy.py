...
BEST_MODEL="alchemab/antiberta2"  
# Modello e tokenizer
...
directory = "/ibmm_data/rodelc/DALM/CLS_bnAbs/CDRH3/data/UNLABEL/repertoires/all_repertoires_HC/healthy"
out_directory = "./cincinnati_repertoires/healthy"
...
for filename in tqdm(all_files, desc="Processing files", unit="file"):
    ...
    try:
        ...
        df.columns = ['id', 'cdrh3', 'label','sequence']
