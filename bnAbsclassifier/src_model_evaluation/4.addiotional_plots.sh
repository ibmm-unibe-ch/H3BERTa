...
## 3_22_24_IMV_LAB
python /ibmm_data/rodelc/DALM/CLS_bnAbs/CDRH3/BEST_RESULTS/H3BERTA:HEALTHY:CDRH3:P3:JUNE2024/src/classification_score_plot.py --test_out_df ./outputs/3_22_24_patient_repertoire_complete_info_IMV_lab/*.csv --save_dir ./additional_plots
